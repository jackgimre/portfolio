  ...
  return (
      <div className='flex flex-col items-center justify-center bg-[#22223b]'>
          <div className='my-4'>
            ...
            <p className='text-center text-[#adb5bd] lg:text-[14pt] sm:text-[12pt]'>Computer Science and Engineering at The Ohio State University</p>
            <div className='flex flex-row text-white justify-center text-[20pt] space-x-3 mt-2'>
              ...
              <a href='https://www.linkedin.com/in/jackgimre' target='_blank'><FontAwesomeIcon icon={faLinkedin}></FontAwesomeIcon></a>
